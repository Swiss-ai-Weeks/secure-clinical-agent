...
2. Apply the resolved identity contract: reuse opaque identities across smoke/seed and reprocessing, keep a persistent restricted source mapping, and preserve synthetic clinical dates/ages. Full generated birth dates belong in authorized structured patient records; do not add them to notes or embedding/vector payloads. Resolve safe projection, coding/components, updates/deletions, and the required existing-volume migrations in the projection ticket.
