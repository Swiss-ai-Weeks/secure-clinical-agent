...
| Identity and provenance | [Decision resolved](../../../.scratch/ingestion-pipeline/issues/04-identity-and-provenance.md#answer); stable opaque registry and restricted traceability are specified, with synthetic DOB retained in structured records only. Adapter, registry, migrations, and runtime checks remain unimplemented. |
