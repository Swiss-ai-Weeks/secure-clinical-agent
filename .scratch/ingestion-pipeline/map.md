...
- Patient counts approved on 2026-09-17: 10-patient smoke fixture then 100-patient seed. The user supplied Synthea and requested a repeatable worker. Its first source stage is implemented; remaining cohort details and downstream security decisions remain open. [Worker runbook](../../backend/ingestion/RUNBOOK.md).
...
- [Choose the first cohort and ingestion success criteria](issues/03-cohort-and-success.md): partial decision on 2026-09-17 approves 10 smoke patients and 100 seed patients; other cohort decisions remain open. [Handoff acceptance scenarios](../../backend/ingestion/tests/README.md) record the confirmed test boundary.
